...
/***/ function(module, exports, __webpack_require__) {
	...
	var Person = __webpack_require__(26);
	var content = __webpack_require__(27);

	var p = new Point(5, 7);
	var wei = new Person('wei');
	content.fullName('Li', 'Chen');
...
/***/ function(module, exports) {
	...
	module.exports = {
	  fullName: function fullName() {
	    var firstName = arguments.length <= 0 || arguments[0] === undefined ? 'Wei' : arguments[0];
	    var lastName = arguments.length <= 1 || arguments[1] === undefined ? 'RuFeng' : arguments[1];
